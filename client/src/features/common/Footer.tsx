    ...
    return (
        <footer className="bg-blue-white dark:bg-blue-dark py-16 px-40 flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="hidden xl:block">
                ...
                <Link to="/" className="text-sm text-white block">О нас</Link>
                <Link to="/" className="text-sm text-white block">Услуги</Link>
                <Link to="/" className="text-sm text-white block">Врачи</Link>
                <Link to="/" className="text-sm text-white block">Отзывы</Link>
                <Link to="/" className="text-sm text-white block">Советы</Link>
                <Link to="/" className="text-sm text-white block">Вакансии</Link>
                <Link to="/" className="text-sm text-white block">Объявления</Link>
            </div>
            <div className="hidden xl:block">
                <h3 className="mt-3 font-bold text-lg text-white">Услуги</h3>
                <Link to="/" className="text-sm text-white block">Терапевтическая стоматология</Link>
                <Link to="/" className="text-sm text-white block">Пародонтология</Link>
                <Link to="/" className="text-sm text-white block">Професиональная Гигиена</Link>
                <Link to="/" className="text-sm text-white block">Протезирования зубов</Link>
                <Link to="/" className="text-sm text-white block">Имплантация Зубов</Link>
                <Link to="/" className="text-sm text-white block">Хирургическая стоматология</Link>
            </div>
            <div>
                <h3 className="mt-3 font-bold text-lg text-white">Контакты</h3>
                <p className="text-sm text-white">г.Алматы пр.Аль-Фараби 41/3</p>
                <div className="flex items-center gap-2">
                    <p className="text-sm text-white">dentalcare@gmail.com</p>
                ...
                <div className="flex items-center gap-2">
                    <p className="text-sm text-white">+7(747) 095 96 85</p>
