...
function Footer() {
    ...
    const bgColor = !visuallyImpairedSettings.isOn ?
        ...
        visuallyImpairedSettings.theme === "black" ?
            ...
            :
            "border-t border-primary-white";

    const textColor = !visuallyImpairedSettings.isOn || visuallyImpairedSettings.theme === "black" ?
        "text-primary-dark"
        :
        "text-primary-white";
    ...
    return (
        <footer className={`${bgColor} py-16 px-20 flex flex-col md:flex-row items-center md:items-start justify-between`}>
            <Logo fill={visuallyImpairedSettings.isOn ? (visuallyImpairedSettings.theme !== "black" ? "black" : "white") : "white"} className={"w-[100px] md:w-[220px]"} />
            ...
            <div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <svg className={fillColor} width="20" height="14" viewBox="0 0 20 14" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <svg className={fillColor} width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="inline-block">
                    <a className="flex items-center gap-2" href="https://instagram.com/dentalplaza.kz?igshid=YmMyMTA2M2Y=">
                        <TextLg className={`${textColor}`}>
                            <div>
                                Instagram
                            </div>
